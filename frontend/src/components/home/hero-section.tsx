      ...
      <div className="container mx-auto">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-10 text-pretty text-lg leading-relaxed text-muted-foreground md:text-xl">
            The most powerful automation platform for modern teams. Connect 1,200+ apps, build intelligent workflows,
            and scale your business without writing code.
          </p>
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            No credit card required • Free forever plan • 14-day trial of premium features
          </p>
        </div>
      </div>
    </section>
